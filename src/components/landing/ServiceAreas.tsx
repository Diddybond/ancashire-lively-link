      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        >
          {areas.map((a, i) => (
            <article
              key={a.region}
              className="group relative bg-background/95 p-8 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.18)] transition-all hover:-translate-y-1 hover:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.25)] lg:p-10"
            >
              ...
              <p className="mt-4 text-lg leading-relaxed text-foreground/75">{a.places}</p>
            </article>
          ))}
        </div>
