  ...
  return (
    <section aria-labelledby="scope-heading" className="py-20 lg:py-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-8 lg:px-12">
        <div
          ref={ref}
          className="reveal-up grid grid-cols-12 gap-6 rounded-sm border border-[color-mix(in_oklab,var(--primary)_22%,transparent)] bg-[color-mix(in_oklab,var(--primary)_5%,transparent)] px-5 py-10 sm:gap-8 sm:px-12 sm:py-12"
        >
          <div className="col-span-12 min-w-0 sm:col-span-3">
            ...
            <p className="mt-3 font-serif text-lg italic leading-snug text-foreground/80 sm:text-xl">
          ...
          <div className="col-span-12 min-w-0 sm:col-span-9">
            <h2
              id="scope-heading"
              className="font-serif text-xl font-medium leading-snug text-foreground sm:text-3xl"
            >
              A non-medical companion and lifestyle coordinator — here to enrich daily life.
            </h2>
            <p className="mt-5 max-w-[60ch] text-base leading-relaxed text-foreground/80 sm:mt-6 sm:text-lg">
            ...
            <p className="mt-4 max-w-[60ch] text-sm leading-relaxed text-foreground/70 sm:text-base">
