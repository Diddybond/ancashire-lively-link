  ...
  head: () => ({
    meta: [
      ...
      { title: "Private Companionship Care & Lifestyle Support in Lancashire | Sabrina Myers" },
      {
        name: "description",
        content:
          "Independent, non-agency companionship care and lifestyle support for older adults across Blackburn with Darwen, Ribble Valley, Preston, Burnley and wider Lancashire. £35/hour. Free first chat with Sabrina.",
      },
      { property: "og:title", content: "Private Companionship Care & Lifestyle Support in Lancashire | Sabrina Myers" },
      {
        property: "og:description",
        content:
          "Independent, non-agency companionship care and lifestyle support for older adults across Blackburn with Darwen, Ribble Valley, Preston, Burnley and wider Lancashire. £35/hour. Free first chat.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Private Companionship Care & Lifestyle Support in Lancashire | Sabrina Myers" },
      { name: "twitter:description", content: "Independent, non-agency companionship care and lifestyle support for older adults across Blackburn with Darwen, Ribble Valley, Preston, Burnley and wider Lancashire." },
          ...
          "@graph": [
            {
              ...
              makesOffer: [
                { "@type": "Offer", name: "Private Companionship Visits", price: "35", priceCurrency: "GBP", priceSpecification: { "@type": "UnitPriceSpecification", price: "35", priceCurrency: "GBP", unitCode: "HUR" } },
            ...
            {
              "@type": "Service",
              name: "Private Companionship Visits",
              ...
              description: "Non-agency, unhurried companionship care from one consistent professional. Weekly or fortnightly visits, two-hour minimum.",
            },
            {
              "@type": "Service",
              ...
              description: "Pre-planned premium outings for older adults — gardens, galleries, tearooms, theatre matinees, favourite places.",
            },
            {
              "@type": "Service",
            ...
            },
            {
              ...
              mainEntity: [
                ...
                { "@type": "Question", name: "Are you insured and DBS checked?", acceptedAnswer: { "@type": "Answer", text: "Yes. I hold an enhanced DBS check, full public liability insurance, and professional indemnity cover. Documentation available on request." } },
                ...
                { "@type": "Question", name: "Do you work with local care homes?", acceptedAnswer: { "@type": "Answer", text: "Yes. As a qualified lifestyle coordinator, I take freelance contracts with local care homes — running bespoke activity programmes, facilitating events, and covering activity coordinator absences. Care home managers can contact me directly to discuss day rates." } },
                { "@type": "Question", name: "How quickly can companionship visits start?", acceptedAnswer: { "@type": "Answer", text: "Most new clients can have an initial free chat within 48 hours, a home visit within a week, and regular visits beginning the week after. Special occasions can be arranged at shorter notice." } },
              ],
            },
          ],
        }),
