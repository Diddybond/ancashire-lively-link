...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "canonical", href: "https://sabrinamyers.co.uk/" },
          ...
          "@graph": [
            {
              ...
              "@id": "https://sabrinamyers.co.uk/#business",
              ...
              founder: { "@id": "https://sabrinamyers.co.uk/#sabrina" },
              makesOffer: [
            ...
            },
            {
              ...
              description: "Planned 4-hour afternoons out for older adults — gardens, galleries, tearooms, theatre matinees, favourite places. Planned in advance with the family. Available for older adults at home, and (subject to the care home's policy) for residents who can leave the home for the day.",
            },
            {
              "@type": "Service",
            ...
            },
            {
              ...
              mainEntity: [
                ...
                { "@type": "Question", name: "Can you take my elderly parent out for the day?", acceptedAnswer: { "@type": "Answer", text: "Yes. Days out are one of the things families value most. I plan outings in advance with the family and your loved one — gardens, galleries, tearooms, favourite walks, theatre matinees, the seaside. The first 15 miles of travel from Blackburn are included free; further mileage is 45p per mile. My Enrichment Days package is a flat £140 for a planned 4-hour afternoon. For relatives in residential care, days out are arranged in agreement with the care home." } },
                ...
                { "@type": "Question", name: "Are you insured and DBS checked?", acceptedAnswer: { "@type": "Answer", text: "Yes. I hold an enhanced DBS check, full public liability insurance, and professional indemnity cover. Documentation is available on request, and can be shared directly with a care home manager before a first visit if needed." } },
